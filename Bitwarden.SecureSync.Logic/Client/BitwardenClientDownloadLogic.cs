...
{
    private const string CLIENT_VERSION_WINDOWS = "v2026.5.0";
    private const string CLIENT_VERSION_OSX = "v2026.5.0";
    private const string CLIENT_VERSION_LINUX = "v2026.5.0";

    private const string WINDOWS_CLIENT_URL =
        "https://github.com/bitwarden/clients/releases/download/cli-v2026.5.0/bw-windows-2026.5.0.zip";

    private const string LINUX_CLIENT_URL =
        "https://github.com/bitwarden/clients/releases/download/cli-v2026.5.0/bw-linux-2026.5.0.zip";

    private const string OSX_CLIENT_URL =
        "https://github.com/bitwarden/clients/releases/download/cli-v2026.5.0/bw-macos-2026.5.0.zip";
